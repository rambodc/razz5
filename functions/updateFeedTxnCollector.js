...
module.exports = async function updateFeedTxnCollector(documentId, params) {
    ...
    try {
        ...
        await admin.firestore().runTransaction(async (transaction) => {
            ...
            // Step 2: Update the transaction document by adding xrpl object inside the receivers array for type "feedCollector"
        ...
        console.error(`Error in updateFeedTxnCollector function for documentId: ${documentId}: ${error.message}`);
